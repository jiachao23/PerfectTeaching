layui.define(['laypage', 'layer',  'table','common','util','form'], function (exports) {
    ...
    table.on('tool(table)', function(obj){
        ...
        if(obj.event === 'del'){
            ...
            common.frame_show('编辑','/admin/notice/form?id='+data.id);
        }
    });
    ...
    form.on('checkbox(visible)', function (data) {
        $.ajax({
            ...
            dataType: "json",
            data: {"type":"visible"},
            url: "/admin/notice/" + data.value + "/change",
    ...
    $('#addNotice').click(function () {
        ...
        setTimeout(function () {
            layer.close(index);
            common.frame_show('添加','/admin/notice/form');
            // layer.msg('打开添加窗口');
        }, 500);
    });
    ...
    var datalist = {
        ...
        editData: function (id) {
            common.frame_show('编辑','/admin/notice/form?id='+id);
        }
    };
    function del(id) {
